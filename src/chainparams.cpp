...
// Copyright (c) 2017-2020 The Deuteriumcoin Core developers
...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vout[0].scriptPubKey.clear();
    txNew.strDZeel = "Deuteriumcoin genesis block";
...
public:
    CMainParams() {
        ...
        consensus.vParameters[Consensus::CONSENSUS_PARAM_DEUNS_FEE].value = 10 * COIN;
        ...
        consensus.vParameters[Consensus::CONSENSUS_PARAMS_DOTDEU_LENGTH].value = 2880 * 400; // 400 days
        consensus.vParameters[Consensus::CONSENSUS_PARAMS_DOTDEU_MAXDATA].value = 1024; // 1KB
        consensus.vParameters[Consensus::CONSENSUS_PARAMS_DOTDEU_FEE_EXTRADATA].value = 3 * COIN;
        ...
        // Deployment of xDEU serialization update
        consensus.vDeployments[Consensus::DEPLOYMENT_XDEU_SER].bit = 33;
        consensus.vDeployments[Consensus::DEPLOYMENT_XDEU_SER].nStartTime = 1637712000; // Nov 24th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_XDEU_SER].nTimeout = 1700784000; // Nov 24th, 2023

        // Deployment of dotDEU update
        consensus.vDeployments[Consensus::DEPLOYMENT_DOT_DEU].bit = 34;
...
public:
    CTestNetParams() {
        ...
        // Deployment of xDEU serialization update
        consensus.vDeployments[Consensus::DEPLOYMENT_XDEU_SER].bit = 33;
        consensus.vDeployments[Consensus::DEPLOYMENT_XDEU_SER].nStartTime = 1633704250; // Oct 8th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_XDEU_SER].nTimeout = 1700784000; // Nov 24th, 2023

        // Deployment of dotDEU update
        consensus.vDeployments[Consensus::DEPLOYMENT_DOT_DEU].bit = 34;
        consensus.vDeployments[Consensus::DEPLOYMENT_DOT_DEU].nStartTime = 1633704250; // Nov 24th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_DOT_DEU].nTimeout = 1700784000; // Nov 24th, 2023
...
public:
    CDevNetParams() {
        ...
        consensus.vParameters[Consensus::CONSENSUS_PARAMS_DAO_VOTE_LIGHT_MIN_FEE].value = 0.1 * COIN;
        consensus.vParameters[Consensus::CONSENSUS_PARAMS_CONFIDENTIAL_TOKENS_ENABLED].value = 1;
        consensus.vParameters[Consensus::CONSENSUS_PARAMS_DOTDEU_LENGTH].value = 400; // 400 blocks
        consensus.vParameters[Consensus::CONSENSUS_PARAMS_DOTDEU_MAXDATA].value = 1024; // 1KB
        consensus.vParameters[Consensus::CONSENSUS_PARAMS_DOTDEU_FEE_EXTRADATA].value = 3 * COIN;
        ...
        // 6) Generate first block using RPC command "./deuteriumcoin-cli generate 1"
