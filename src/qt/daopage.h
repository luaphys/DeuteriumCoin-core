...
private:
    ...
    QLabel* viewLbl;
    DeuteriumcoinPushButton* proposalsBtn;
    DeuteriumcoinPushButton* paymentRequestsBtn;
    DeuteriumcoinPushButton* consultationsBtn;
    DeuteriumcoinPushButton* deploymentsBtn;
    DeuteriumcoinPushButton* consensusBtn;
    QLabel* filterLbl;
