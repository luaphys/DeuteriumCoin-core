...
#ifndef DEUTERIUMCOIN_QT_SENDCOINSDIALOG_H
#define DEUTERIUMCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending deuteriumcoins */
...
#endif // DEUTERIUMCOIN_QT_SENDCOINSDIALOG_H
