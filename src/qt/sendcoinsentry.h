...
#ifndef DEUTERIUMCOIN_QT_SENDCOINSENTRY_H
#define DEUTERIUMCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending deuteriumcoins.
...
#endif // DEUTERIUMCOIN_QT_SENDCOINSENTRY_H
