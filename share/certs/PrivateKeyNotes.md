...
unlocked to sign the Deuteriumcoin-Qt.app bundle.
...
allowing somebody to distribute a Deuteriumcoin-Qt.app or deuteriumcoin-qt-setup.exe with a valid
...
that the deuteriumcoin-qt.exe file inside the installer had not been tampered with.
