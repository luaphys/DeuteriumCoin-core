# Deuteriumcoin v6.1.0 Release Notes

## Check inputs standard xDEU

<[Pull Request 797](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/797)>

## Prevent adding duplicated inputs from candidates

<[Pull Request 798](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/798)>

## Restart testnet

<[Pull Request 799](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/799)>

## GUI lock up optimization

<[Pull Request 801](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/801)>
...
<[Pull Request 802](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/802)>

Patch for xDEU duplicated candidates.

## Added a missing style for QWizard background color

<[Pull Request 804](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/804)>

## Prevent duplicated remove vote

<[Pull Request 805](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/805)>
...
Example: https://www.deuexplorer.com/block/4987836

This PR fixes the behavior.

## Prevent mixed use of DEU and recently swapped xDEU->DEU

<[Pull Request 806](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/806)>
...
<[Pull Request 809](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/809)>

## Fixed with-pic flag for libsodium build

<[Pull Request 813](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/813)>

## Reduce blsCT-related logging

<[Pull Request 816](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/816)>

## Fix xDEU tx history duplicated

<[Pull Request 817](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/817)>

## Show encrypted msg in transaction details

<[Pull Request 818](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/818)>

## Check for null pointer in BuildMixCounters

<[Pull Request 819](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/819)>

## Fixed: Syntax Error

<[Pull Request 820](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/820)>

## Update wallet with new logos

<[Pull Request 821](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/821)>

## Fix memory exhaustion from candidates storage

<[Pull Request 823](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/823)>
...
<[Pull Request 826](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/826)>
...
<[Pull Request 827](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/827)>

Continuation of #805, this PR fixes a bug where the wallet would still add REMOVE votes if the entry expired.

## Only broadcast xdeu when received version

<[Pull Request 829](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/829)>
...
<[Pull Request 832](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/832)>
...
<[Pull Request 833](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/833)>

## Fix address history sorting

<[Pull Request 834](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/834)>
...
<[Pull Request 835](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/835)>

## Use inventory for aggregation sessions and encrypted candidates

<[Pull Request 836](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/836)>
...
<[Pull Request 837](https://github.com/deuteriumcoin/deuteriumcoin-core/pull/837)>

This PR bumps protocol version to 80021.

Peers with prot.version older than 80020 are banned.
Peers with prot.version 80020 receive a message about the need to update to 80021 (xDEU INV PR #836)
