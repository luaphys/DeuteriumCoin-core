...
# Deuteriumcoin v4.2.0 Release Notes
...
### Community Fund - Accumulation of coins, signaled by version bit 7:
  ...
  - Inclusion of an additional output in the Coinstake transaction contributing 0.25DEU to the Community Fund
...
- Accepts URI to sign messages.
    - URIs of the format deuteriumcoin:http://domain/something/?a=deuteriumcoin_address&m=some_message will make the wallet to sign “some_message” and return the produced signature as a POST request to the URL specified in the URI.
...
- deuteriumcoin-tx tool has been updated to use deuteriumcoin’s own transaction structure
