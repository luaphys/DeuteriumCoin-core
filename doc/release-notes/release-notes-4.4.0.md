# Deuteriumcoin v4.4.0 Release Notes
...
- Fee to create a Proposal: 50 DEU
...
You can read more about [NPIP0003 on the NPIP GitHub](https://github.com/deuteriumcoin/npips/blob/master/npip-0003.mediawiki).

## Community Fund Contribution Increase

The Version Bit 16 will signal for the soft fork to increase the Community Fund contribution from 0.25 DEU to 0.50 DEU per block. 

You can read more about [NPIP0005 on the NPIP GitHub](https://github.com/deuteriumcoin/npips/blob/master/npip-0005.mediawiki).
...
```
createproposal deuteriumcoinaddress amount duration "desc" fee

Arguments:
1. "deuteriumcoinaddress" (string, required) The deuteriumcoin address where coins would be sent if the proposal is approved.
2. "amount" The amount in DEU to request. eg 100
...
2. "amount" (numeric or string, required) The amount in DEU to withdraw. eg 10
...
Donate DEU from your wallet to the commnuity fund

Arguments:
1. "amount" (string, required) The amount of DEU to donate
```
