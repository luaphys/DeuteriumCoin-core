...
The script [extract-osx-sdk.sh](https://github.com/deuteriumcoin/deuteriumcoin-core/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
