...
`test/pull-tester/test_framework/test_framework.py:DeuteriumcoinTestFramework.main`.
...
if 'ENABLE_WALLET' not in vars():
    ENABLE_WALLET=0
if 'ENABLE_DEUTERIUMCOIND' not in vars():
    ENABLE_DEUTERIUMCOIND=0
...
#Set env vars
if "DEUTERIUMCOIND" not in os.environ:
    os.environ["DEUTERIUMCOIND"] = BUILDDIR + '/src/deuteriumcoind' + EXEEXT
if "DEUTERIUMCOINCLI" not in os.environ:
    os.environ["DEUTERIUMCOINCLI"] = BUILDDIR + '/src/deuteriumcoin-cli' + EXEEXT

if EXEEXT == ".exe" and "-win" not in opts:
    # https://github.com/deuteriumcoin/deuteriumcoin/commit/d52802551752140cf41f0d9a225a43e84404d3e9
    # https://github.com/deuteriumcoin/deuteriumcoin/pull/5677#issuecomment-136646964
    print("Win tests currently disabled by default.  Use -win option to enable")
    sys.exit(0)

if not (ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_DEUTERIUMCOIND == 1):
    print("No rpc tests to run. Wallet, utils, and deuteriumcoind must all be enabled")
    sys.exit(0)
...
class RPCCoverage(object):
    ...
    commands per `deuteriumcoin-cli help` (`rpc_interface.txt`).
