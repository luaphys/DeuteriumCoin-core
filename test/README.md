...
Every pull request to the deuteriumcoin repository is built and run through
...
```
  ...
  --nocleanup           Leave deuteriumcoinds and test.* datadir on exit or error
  --noshutdown          Don't stop deuteriumcoinds after the test execution
  --srcdir=SRCDIR       Source directory containing deuteriumcoind/deuteriumcoin-cli
                        (default: ../../src)
...
blocks (25*50=1250 DEU) in its wallet.
